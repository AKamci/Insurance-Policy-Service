package PolicyProject.policyService.infrastructure.strategy.WeightStrategy.WeightStrategy.EngineClassStrategy;
...
public class EngineClassStrategy  implements IWeightStrategy {
    @Override
    ...
    public BigDecimal getValue(LicensePlateModel model) {
        return BigDecimal.valueOf(model.car().getEngine());
    }
}
