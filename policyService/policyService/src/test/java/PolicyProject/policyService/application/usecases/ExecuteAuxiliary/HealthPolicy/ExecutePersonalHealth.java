...
public class ExecutePersonalHealth {
    ...
    public ExecutePersonalHealth(PersonalHealthGateway personalHealthGateway, ExecuteHealthPolicyWeight executeHealthPolicyWeight, ExecuteCustomer executeCustomer) {
        this.personalHealthGateway = personalHealthGateway;
        this.executeHealthPolicyWeight = executeHealthPolicyWeight;
