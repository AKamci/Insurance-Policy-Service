...
public class ExecuteHealthPolicy {
    ...
    public ExecuteHealthPolicy(HealthPolicyGateway healthPolicyGateway, ExecuteCustomer executeCustomer, HealthPolicySpecificationBuild healthPolicySpecificationBuild, ExecutePersonalHealth executePersonalHealth) {
        this.healthPolicyGateway = healthPolicyGateway;
        this.executeCustomer = executeCustomer;
        this.healthPolicySpecificationBuild = healthPolicySpecificationBuild;
        this.executePersonalHealth = executePersonalHealth;
    }
