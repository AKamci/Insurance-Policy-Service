...
public class ExecuteHealthPolicyWeightTest {

    @Mock
    private HealthPolicyWeightGateway weightGateway;
    @Mock
    private HealthPolicyWeightMapper carPolicyWeightsMapper;
    @Mock
    HealthPolicyWeightStrategyFactory carPolicyWeightStrategyFactory;
    @InjectMocks
    private ExecuteHealthPolicyWeight executeCarPolicyWeight;
    @BeforeEach
    void setUp() {
        executeCarPolicyWeight = new ExecuteHealthPolicyWeight(weightGateway, carPolicyWeightStrategyFactory);
    }
    @Test
    void testExecuteUpdateList_Success() {
        ...
        HealthPolicyWeight entity1 = HealthPolicyWeightMapper.INSTANCE.WeightsModelToWeightEntity(model1);
        HealthPolicyWeight entity2 = HealthPolicyWeightMapper.INSTANCE.WeightsModelToWeightEntity(model2);
        List<HealthPolicyWeight> weightsEntities = List.of(entity1, entity2);
    ...
    void testExecuteUpdate_Success() {
        ...
        HealthPolicyWeight entity = HealthPolicyWeightMapper.INSTANCE.WeightsModelToWeightEntity(model);
    ...
    void testExecuteGetList_Success() {
        HealthPolicyWeight entity1 = new HealthPolicyWeight(1L, "key1", new BigDecimal("10.0"), new BigDecimal("1.0"), new BigDecimal("20.0"), "type1");
        HealthPolicyWeight entity2 = new HealthPolicyWeight(2L, "key2", new BigDecimal("20.0"), new BigDecimal("2.0"), new BigDecimal("30.0"), "type2");
        List<HealthPolicyWeight> weightsEntities = List.of(entity1, entity2);
    ...
    void testGet_ALicensePlateModel_Success() {
        PersonalHealthModel personalHealthModel = new PersonalHealthModel(null, null, null, null, null, null, null, null,
                null,null, null,
                null,null, null,
                null);

        when(weightGateway.list()).thenReturn(List.of(new HealthPolicyWeight(1L, "key1", new BigDecimal("2.0"), new BigDecimal("1.0"), new BigDecimal("10.0"), "constant")));
        when(carPolicyWeightStrategyFactory.getStrategy(any())).thenReturn(new HealthPolicyConstant_Strategy());

        PersonalHealthModel result = executeCarPolicyWeight.Get_APersonalHealthModel(personalHealthModel,100);
        assertNotNull(result);
    ...
    void testGet_ALicensePlateModel_EntityNotFoundException() {
        ...
        Exception exception = assertThrows(NullPointerException.class, () -> {
            executeCarPolicyWeight.Get_APersonalHealthModel(personalHealthModel, 100);
        });
