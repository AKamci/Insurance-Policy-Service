...
public class CarPolicyWeightsMapperTest {
    private final CarPolicyWeightsMapper mapper = CarPolicyWeightsMapper.INSTANCE;

    @Test
    public void testWeightsEntityListToWeightsModelList_allFields() {
        List<Weights> entities = List.of(
                new Weights(1L, "key1", new BigDecimal("10.5"), new BigDecimal("1.0"), new BigDecimal("20.0"), "type1"),
                new Weights(2L, "key2", new BigDecimal("15.5"), new BigDecimal("2.0"), new BigDecimal("25.0"), "type2")
        );
    ...
    public void testWeightsEntityListToWeightsModelList_nullValues() {
        List<Weights> entities = List.of(
                new Weights(null, null, null, null, null, null),
                new Weights(null, null, null, null, null, null)
        );
    ...
    public void testWeightsEntityListToWeightsModelList_partialFields() {
        List<Weights> entities = List.of(
                new Weights(1L, "key1", null, new BigDecimal("1.0"), null, "type1"),
                new Weights(2L, "key2", new BigDecimal("15.5"), null, new BigDecimal("25.0"), null)
        );
    ...
    public void testWeightsModelToWeightEntity_allFields() {
        ...
        Weights entity = mapper.WeightsModelToWeightEntity(model);
    ...
    public void testWeightsModelListToWeightEntityList_allFields() {
        ...
        List<Weights> entities = mapper.WeightsModelListToWeightEntityList(models);

        assertNotNull(entities);
        assertEquals(2, entities.size());

        Weights entity1 = entities.get(0);
        ...
        Weights entity2 = entities.get(1);
