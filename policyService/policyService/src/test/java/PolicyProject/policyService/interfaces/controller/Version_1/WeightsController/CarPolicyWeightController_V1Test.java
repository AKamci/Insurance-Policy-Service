...
@WebMvcTest(CarPolicyWeightController_V1.class)
public class CarPolicyWeightController_V1Test {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new CarPolicyWeightController_V1(carPolicyWeightService)).build();
    }
    ...
    void getWeightTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/weight")
    ...
    void updateWeightTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/weight")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void deleteWeightTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/weight")
                        .param("key", "exampleKey")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.key").value("exampleKey"));
    ...
    void getWeightsTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/weight/list")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void updateWeightsAllTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/weight/saveAll")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void getPriceTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/weight/getPrice")
                        .param("key", "exampleKey")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.key").value("exampleKey"))
