...
public class HealthPolicyWeightsMapperTest {
    private final HealthPolicyWeightMapper mapper = HealthPolicyWeightMapper.INSTANCE;

    @Test
    public void testWeightsEntityListToWeightsModelList_allFields() {
        List<HealthPolicyWeight> entities = List.of(
                new HealthPolicyWeight(1L, "key1", new BigDecimal("10.5"), new BigDecimal("1.0"), new BigDecimal("20.0"), "type1"),
                new HealthPolicyWeight(2L, "key2", new BigDecimal("15.5"), new BigDecimal("2.0"), new BigDecimal("25.0"), "type2")
        );
    ...
    public void testWeightsEntityListToWeightsModelList_nullValues() {
        List<HealthPolicyWeight> entities = List.of(
                new HealthPolicyWeight(null, null, null, null, null, null),
                new HealthPolicyWeight(null, null, null, null, null, null)
        );
    ...
    public void testWeightsEntityListToWeightsModelList_partialFields() {
        List<HealthPolicyWeight> entities = List.of(
                new HealthPolicyWeight(1L, "key1", null, new BigDecimal("1.0"), null, "type1"),
                new HealthPolicyWeight(2L, "key2", new BigDecimal("15.5"), null, new BigDecimal("25.0"), null)
        );
    ...
    public void testWeightsEntityToWeightsModel_allFields() {
        HealthPolicyWeight entity = new HealthPolicyWeight(
                1L,
                "testKey",
                new BigDecimal("10.5"),
                new BigDecimal("1.0"),
    ...
    public void testWeightsModelToWeightEntity_allFields() {
        ...
        HealthPolicyWeight entity = mapper.WeightsModelToWeightEntity(model);
    ...
    public void testWeightsModelListToWeightEntityList_allFields() {
        ...
        List<HealthPolicyWeight> entities = mapper.WeightsModelListToWeightEntityList(models);

        assertNotNull(entities);
        assertEquals(2, entities.size());

        HealthPolicyWeight entity1 = entities.get(0);
        ...
        HealthPolicyWeight entity2 = entities.get(1);
