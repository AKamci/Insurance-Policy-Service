...
@WebMvcTest(HealthPolicyWeightController_V1.class)
public class HealthPolicyWeightController_V1Test{

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private HealthPolicyWeightService carPolicyWeightService;
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new HealthPolicyWeightController_V1(carPolicyWeightService)).build();
    }
    ...
    void createWeightTest() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/healthPolicyWeight")
    ...
    void getWeightTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/healthPolicyWeight")
    ...
    void updateWeightTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/healthPolicyWeight")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void deleteWeightTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/healthPolicyWeight")
                        .param("key", "exampleKey")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.key").value("exampleKey"));
    ...
    void getWeightsTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/healthPolicyWeight/list")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void updateWeightsAllTest() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/healthPolicyWeight/saveAll")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void getPriceTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/healthPolicyWeight/getPrice")
                        .param("key", "exampleKey")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.key").value("exampleKey"))
